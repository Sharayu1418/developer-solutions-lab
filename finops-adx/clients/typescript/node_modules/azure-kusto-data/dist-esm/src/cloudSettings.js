...
class CloudSettings {
    constructor() {
        ...
        this.cloudCache = {};
        this.getFromCache = (kustoUri) => this.cloudCache[this.getCacheKey(kustoUri)];
        this.deleteFromCache = (kustoUri) => delete this.cloudCache[this.getCacheKey(kustoUri)];
    }
    writeToCache(url, info) {
        this.cloudCache[this.getCacheKey(url)] = info !== null && info !== void 0 ? info : this.defaultCloudInfo;
    }
